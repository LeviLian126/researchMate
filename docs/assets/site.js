...
if (mastRow) {
  ...
  switcher.href = isChinese ? '../index.html' : `${document.location.pathname.includes('/contracts/') ? '../../' : document.location.pathname.includes('/product/') || document.location.pathname.includes('/architecture/') ? '../' : ''}zh/index.html`;
