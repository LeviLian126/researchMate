...
Use this guide for README files, architecture and API documentation, design notes, PR descriptions, code review findings, runbooks, incident updates, release notes, and technical explanations. Apply the Humanizer pattern guides as an audit, not as a mechanical word ban.
