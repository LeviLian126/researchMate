...
- If a required runtime is missing (e.g. database not installed, Redis unavailable),
  mark CP5 as NOT_RUN and record exactly what is missing. Do not claim the app works
  when you could not start it.
