...
Read only the upstream handoff that defines the changed surface or contract and identify target user, context, job, primary action,
...
the default `humanizer` skill. Keep short interface copy focused on
